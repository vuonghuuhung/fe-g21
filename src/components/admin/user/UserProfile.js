    ...
    <div className="h-full mt-4">
      ...
      <div className="flex relative">
        <div className="w-full text-center">
          <h1 className="font-bold text-3xl p-2">User</h1>
          <div className="text-xl pb-6">User profile</div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex text-xl">
          <div className="ml-80 mr-20 shadow-xl">
            <img
              src="https://www.material-tailwind.com/img/face-2.jpg"
              alt=""
            />
          </div>
          <div className="w-1/3 bg-orange-50 rounded-xl p-8 shadow-lg">
            ...
            <div className="flex mb-3 justify-start">
              ...
              <div>
                Address: {user.address_node}, {user.address.path_with_type}
              </div>
            </div>
            <div className="flex mb-3 justify-start items-center">
              <svg
            ...
            <div className="flex mb-3 justify-start items-center">
              ...
              <div>Total orders: {user.order}</div>
            </div>
            <div className="flex mb-3 justify-start items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
