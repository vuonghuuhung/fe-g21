  ...
  return (
    <div className="bg-blue-400 flex flex-col gap-1 px-8 pt-16 pb-8 md:px-16 md:pt-8 text-white w-full md:h-auto">
      ...
      <div className="mt-8 mb-6 md:mt-16">
        <p className="float-left mb-1 w-full md:inline-block md:w-auto">
          © 2020 Pattern
        </p>
        <p className="float-left ml-3 mb-1 md:float-right md:ml-8">
          Accessibility
        </p>
        <p className="float-right ml-3 mb-1 md:float-right md:ml-8">
          Privacy Policy
        </p>
        <p className="float-left ml-3 mb-1 w-full md:float-right md:w-auto md:ml-8">
          Terms & Conditions
        </p>
      </div>
    </div>
